...
def run():
    ...
    dsl_pipeline = run_pipeline.create_pipeline(
                        ...
                        vertex_training_args=configs.VERTEX_TRAINING_ARGS,
                        # TODO(step 9): (Optional) Uncomment below to use Cloud AI Platform.
                        vertex_serving_args=configs.VERTEX_SERVING_ARGS,
                        use_gpu = False,
